...
class RabbitMQProvider {
  ...
  get(params) {
    ...
    return that._exec(params, pattern, (vp) => {
      return new Promise((resolve, reject) => {
        ...
        that.channel.get(vp.queue, {noAck: false}, function(getErr, msg) {
          if (getErr) {
   ...
   * @param {object} params - object parameters
   * @param {string} params.queue - the queue name where to produce the message
   * @param {function} params.cb - callback functionto run after consuming a message
