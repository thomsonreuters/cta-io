  ...
  produce(params) {
    ...
    try {
      ...
      return new Promise((resolve, reject) => {
        self._connect()
        .then(function() {
          self.channel.assertQueue(params.queue, {durable: params.extra.mq_durable});
          self.channel.sendToQueue(params.queue, self._jsonToBuffer(params.json), {persistent: params.extra.mq_persistent});
      ...
      return Promise.reject({id: 'mq_produce_01', err: e.message});
    }
  }
