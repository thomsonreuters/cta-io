...
class IoBrick extends Brick {
  ...
  constructor(cementHelper, config) {
    ...
    // TODO Ensure we have messaging dependency or throw error if not?
  ...
  _get(queue) {
    ...
    return new Promise((resolve, reject) => {
      that.messaging.get(queue || that.inputQueue)
        .then(function(data) {
