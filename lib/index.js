...
class Sqr {
   ...
   * @param {object} options.silo - silo configuration, refer to silo doc
   */
  constructor(providerName, options) {
    ...
    try {
      ...
      console.error(`Warning: provider ${providerName} doesn't provide on.reconnected event`);
    }
  }
  ...
  _exec(o) {
    ...
    return new Promise((resolve, reject) => {
      co(function* () {
        ...
        if (self.provider.extra && o.method in self.provider.extra) {
